...
/*：这是演示代码,不能开发用。源码下载唯一地址: http://www.bootstrapmb.com/item/7166。(这个备注仅在演示页面有，源代码里没有。)*/:root {
	--sky: #124380;
	--sea: #002a6b;
	--ground: #00112c;
	--road: #000b1c;
...
}/*：这是演示代码,不能开发用。源码下载唯一地址: http://www.bootstrapmb.com/item/7166。(这个备注仅在演示页面有，源代码里没有。)*/
</style>
